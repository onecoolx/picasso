...
namespace agg
{
    ...
    public:
        ...
        //--------------------------------------------------------------------
        template<class Img> void blur_x(Img& img, float radius)
        {
        ...
        //--------------------------------------------------------------------
        template<class Img> void blur_y(Img& img, float radius)
        {
            pixfmt_transposer<Img> img2(img);
            blur_x(img2, radius);
        }
        ...
        //--------------------------------------------------------------------
        template<class Img> void blur(Img& img, float radius)
        {
            blur_x(img, radius);
            pixfmt_transposer<Img> img2(img);
            blur_x(img2, radius);
    ...
    template<class T=float> struct recursive_blur_calc_rgba
    {
        typedef T value_type;
    ...
    template<class T=float> struct recursive_blur_calc_rgb
    {
        typedef T value_type;
    ...
    template<class T=float> struct recursive_blur_calc_gray
    {
        typedef T value_type;
