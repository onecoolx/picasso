...
namespace agg
{
    ...
    struct ras_conv_int
    {
        ...
        static int upscale(float v) { return iround(v * poly_subpixel_scale); }
    ...
    struct ras_conv_dbl
    {
        ...
        static int xi(float v) { return iround(v * poly_subpixel_scale); }
        static int yi(float v) { return iround(v * poly_subpixel_scale); }
        static float upscale(float v) { return v; }
        static float downscale(int v)  { return v / float(poly_subpixel_scale); }
    };
    ...
    struct ras_conv_dbl_3x
    {
        ...
        static int xi(float v) { return iround(v * poly_subpixel_scale * 3); }
        static int yi(float v) { return iround(v * poly_subpixel_scale); }
        static float upscale(float v) { return v; }
        static float downscale(int v)  { return v / float(poly_subpixel_scale); }
    };
    ...
    public:
        ...
        typedef typename Conv::scale_type scale_type;
