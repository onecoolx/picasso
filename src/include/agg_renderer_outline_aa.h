...
namespace agg
{
    ...
    public:
        ...
        line_profile_aa(float w, const GammaF& gamma_function) : 
            m_subpixel_width(0),
            m_min_width(1.0),
            m_smoother_width(1.0)
        {
        ...
        //---------------------------------------------------------------------
        void min_width(float w) { m_min_width = w; }
        void smoother_width(float w) { m_smoother_width = w; }
        ...
        { 
            ...
            for(i = 0; i < aa_scale; i++)
            {
                m_gamma[i] = value_type(
                    uround(gamma_function(float(i) / aa_mask) * aa_mask));
            }
        }
        ...
        float smoother_width() const { return m_smoother_width; }
    ...
    private:
        ...
        value_type* profile(float w);
        void set(float center_width, float smoother_width);
