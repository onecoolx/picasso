...
namespace agg
{
    ...
    public:
        ...
        void angle_tolerance(float) {}
        float angle_tolerance() const { return 0.0; }

        void cusp_limit(float) {}
        float cusp_limit() const { return 0.0; }
    ...
    public:
        ...
        void angle_tolerance(float a) { m_angle_tolerance = a; }
        float angle_tolerance() const { return m_angle_tolerance;  }
    ...
    struct curve4_points
    {
        ...
        float  operator [] (unsigned i) const { return cp[i]; }
        float& operator [] (unsigned i)       { return cp[i]; }
    };
    ...
    //-------------------------------------------------------catrom_to_bezier
    inline curve4_points catrom_to_bezier(float x1, float y1, 
                                          float x2, float y2, 
                                          float x3, float y3,
                                          float x4, float y4)
    {
    ...
    //-----------------------------------------------------ubspline_to_bezier
    inline curve4_points ubspline_to_bezier(float x1, float y1, 
                                            float x2, float y2, 
                                            float x3, float y3,
                                            float x4, float y4)
    {
    ...
    //------------------------------------------------------hermite_to_bezier
    inline curve4_points hermite_to_bezier(float x1, float y1, 
                                           float x2, float y2, 
                                           float x3, float y3,
                                           float x4, float y4)
    {
    ...
    public:
        ...
        void cusp_limit(float v) 
        { 
            m_cusp_limit = (v == 0.0f) ? 0.0f : pi - v; 
        }

        float cusp_limit() const 
        { 
    ...
    public:
        ...
        float approximation_scale() const { return m_curve_inc.approximation_scale(); }

        void angle_tolerance(float v) 
        { 
