...
// 
//----------------------------------------------------------------------------
#ifndef AGG_SPAN_IMAGE_FILTER_RGB_PACKED_INCLUDED
#define AGG_SPAN_IMAGE_FILTER_RGB_PACKED_INCLUDED
...
namespace agg
{
    //===============================================span_image_filter_rgb_packed_nn
    template<class Source, class Interpolator> 
    class span_image_filter_rgb_packed_nn : 
    ...
    public:
        ...
        //--------------------------------------------------------------------
        span_image_filter_rgb_packed_nn() {}
        span_image_filter_rgb_packed_nn(source_type& src, 
    ...
    //==========================================span_image_filter_rgb_packed_bilinear
    template<class Source, class Interpolator> 
    class span_image_filter_rgb_packed_bilinear : 
    public span_image_filter<Source, Interpolator>
    {
    public:
        typedef Source source_type;
        ...
        //--------------------------------------------------------------------
        span_image_filter_rgb_packed_bilinear() {}
        span_image_filter_rgb_packed_bilinear(source_type& src, 
                                       interpolator_type& inter) :
            base_type(src, inter, 0) 
        {}
        ...
        void generate(color_type* span, int x, int y, unsigned len)
        {
            ...
            do
            {
                ...
                fg[0] = 
                fg[1] = 
                fg[2] = (image_subpixel_scale * image_subpixel_scale) >> 1;
                ...
                span->r = value_type(fg[0] >> (image_subpixel_shift << 1));
                span->g = value_type(fg[1] >> (image_subpixel_shift << 1));
                span->b = value_type(fg[2] >> (image_subpixel_shift << 1));
                span->a = base_mask;
    ...
    //=====================================span_image_filter_rgb_packed_bilinear_clip
    template<class Source, class Interpolator> 
    class span_image_filter_rgb_packed_bilinear_clip : 
    public span_image_filter<Source, Interpolator>
    {
    public:
        typedef Source source_type;
        ...
        //--------------------------------------------------------------------
        span_image_filter_rgb_packed_bilinear_clip() {}
        span_image_filter_rgb_packed_bilinear_clip(source_type& src, 
            ...
            do
            {
                   ...
                   x_lr <  maxx && y_lr <  maxy) 
                {
                    ...
                    fg_ptr = (const value_type*)
                        base_type::source().row_ptr(y_lr) + x_lr + x_lr;
                    weight = (image_subpixel_scale - x_hr) * 
                             (image_subpixel_scale - y_hr);
                    rgb_pixel = *reinterpret_cast<const pixel_type*>(fg_ptr);
                    fg[0] += weight * ((rgb_pixel & r_mask) >> (order_type::G + order_type::B));
                    ...
                    fg[0] >>= (image_subpixel_shift << 1);
                    fg[1] >>= (image_subpixel_shift << 1);
                    fg[2] >>= (image_subpixel_shift << 1);
                    src_alpha = base_mask;
                }
                else
                {
                    ...
                    else
                    {
                        ...
                        fg[1] = 
                        fg[2] = 
                        src_alpha = (image_subpixel_scale * image_subpixel_scale) >> 1;
                        ...
                        fg[1] >>= (image_subpixel_shift << 1);
                        fg[2] >>= (image_subpixel_shift << 1);
                        src_alpha >>= (image_subpixel_shift << 1);
                    }
                }
    ...
    //===============================================span_image_filter_rgb_packed_2x2
    template<class Source, class Interpolator> 
    class span_image_filter_rgb_packed_2x2 : 
    public span_image_filter<Source, Interpolator>
    {
    public:
        typedef Source source_type;
        ...
        //--------------------------------------------------------------------
        span_image_filter_rgb_packed_2x2() {}
        span_image_filter_rgb_packed_2x2(source_type& src, 
                                  interpolator_type& inter,
    ...
    template<class Source, class Interpolator> 
    class span_image_filter_rgb_packed : 
    public span_image_filter<Source, Interpolator>
    {
    public:
        typedef Source source_type;
        ...
        //--------------------------------------------------------------------
        span_image_filter_rgb_packed() {}
        span_image_filter_rgb_packed(source_type& src, 
                              interpolator_type& inter,
                              const image_filter_lut& filter) :
            base_type(src, inter, &filter) 
        {}
    ...
    //==========================================span_image_resample_rgb_packed_affine
    template<class Source> 
    class span_image_resample_rgb_packed_affine : 
    ...
    public:
        ...
        //--------------------------------------------------------------------
        span_image_resample_rgb_packed_affine() {}
        span_image_resample_rgb_packed_affine(source_type& src, 
                                       interpolator_type& inter,
                                       const image_filter_lut& filter) :
            base_type(src, inter, filter) 
        {}
    ...
    template<class Source, class Interpolator>
    class span_image_resample_rgb_packed : 
    ...
    public:
        ...
        //--------------------------------------------------------------------
        span_image_resample_rgb_packed() {}
        span_image_resample_rgb_packed(source_type& src, 
                                interpolator_type& inter,
                                const image_filter_lut& filter) :
            base_type(src, inter, filter)
        {}
