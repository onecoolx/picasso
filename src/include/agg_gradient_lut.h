...
namespace agg
{
    ...
    public:
        ...
        {
            return m_c1.gradient(m_c2, float(m_count) / m_len);
        }
    ...
    public:
        ...
        //--------------------------------------------------------------------
        void remove_all();
        void add_color(float offset, const color_type& color);
        void build_lut();
    ...
    private:
        ...
        struct color_point
        {
            ...
            color_point() {}
            color_point(float off, const color_type& c) : 
                offset(off), color(c)
            {
    ...
    //------------------------------------------------------------------------
    template<class T, unsigned S>
    void gradient_lut<T,S>::add_color(float offset, const color_type& color)
    {
