...
namespace agg
{
    ...
    public:
        ...
        //--------------------------------------------------------------------
        float height()    const { return m_font[0]; }
        float base_line() const { return m_font[1]; }

        //--------------------------------------------------------------------
        template<class CharT>
        float width(const CharT* str) const
        {
        ...
        //--------------------------------------------------------------------
        void prepare(glyph_rect* r, float x, float y, unsigned glyph, bool flip)
        {
            unsigned start_char = m_font[2];
            unsigned num_chars = m_font[3];
