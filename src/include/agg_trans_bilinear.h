...
namespace agg
{
    ...
    public:
        ...
        trans_bilinear(const float* src, const float* dst) 
        {
        ...
        trans_bilinear(float x1, float y1, float x2, float y2, 
                       const float* quad)
        {
        ...
        trans_bilinear(const float* quad, 
        ...
        public:
            ...
            iterator_x() {}
            iterator_x(float tx, float ty, float step, const float m[4][2]) :
