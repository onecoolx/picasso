...
namespace agg
{
    ...
    private:
        ...
        bool next_contour();
        bool next_vertex(float* x, float* y);
    ...
    //------------------------------------------------------------------------
    template<class VSA, class VSB> 
    inline void conv_gpc<VSA, VSB>::add_vertex(float x, float y)
    {
        gpc_vertex v;
        v.x = x;
        v.y = y;
    ...
    //------------------------------------------------------------------------
    template<class VSA, class VSB> 
    inline bool conv_gpc<VSA, VSB>::next_vertex(float* x, float* y)
    {
    ...
    //------------------------------------------------------------------------
    template<class VSA, class VSB> 
    unsigned conv_gpc<VSA, VSB>::vertex(float* x, float* y)
    {
