...
namespace agg
{
    ...
    public:
        ...
        void master_alpha(int style, float alpha);
    ...
    //------------------------------------------------------------------------
    template<class Clip> 
    void rasterizer_compound_aa<Clip>::clip_box(float x1, float y1, 
                                                float x2, float y2)
    {
        reset();
    ...
    //------------------------------------------------------------------------
    template<class Clip> 
    void rasterizer_compound_aa<Clip>::move_to_d(float x, float y) 
    { 
        if(m_outline.sorted()) reset();
    ...
    //------------------------------------------------------------------------
    template<class Clip> 
    void rasterizer_compound_aa<Clip>::line_to_d(float x, float y) 
    { 
        m_clipper.line_to(m_outline, 
                          conv_type::upscale(x), 
                          conv_type::upscale(y)); 
    ...
    //------------------------------------------------------------------------
    template<class Clip> 
    void rasterizer_compound_aa<Clip>::add_vertex(float x, float y, unsigned cmd)
    {
        if(is_move_to(cmd)) 
        {
            move_to_d(x, y);
    ...
    //------------------------------------------------------------------------
    template<class Clip> 
    void rasterizer_compound_aa<Clip>::edge_d(float x1, float y1, 
                                              float x2, float y2)
    {
        if(m_outline.sorted()) reset();
    ...
    //------------------------------------------------------------------------ 
    template<class Clip> 
    void rasterizer_compound_aa<Clip>::master_alpha(int style, float alpha)
    {
        if(style >= 0)
        {
