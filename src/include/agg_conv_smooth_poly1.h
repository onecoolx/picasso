...
namespace agg
{
    ...
    public conv_adaptor_vcgen<VertexSource, vcgen_smooth_poly1>
    {
        ...
        void   smooth_value(float v) { base_type::generator().smooth_value(v); }
        float smooth_value() const { return base_type::generator().smooth_value(); }
    ...
    public conv_curve<conv_smooth_poly1<VertexSource> >
    {
        ...
        void   smooth_value(float v) { m_smooth.generator().smooth_value(v); }
        float smooth_value() const { return m_smooth.generator().smooth_value(); }
