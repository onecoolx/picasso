...
namespace agg
{
    ...
    public:
        ...
        span_interpolator_persp_exact(const float* src, const float* dst) 
        {
        ...
        span_interpolator_persp_exact(float x1, float y1, 
                                      float x2, float y2, 
                                      const float* quad)
        {
        ...
        span_interpolator_persp_exact(const float* quad, 
                                      float x1, float y1, 
                                      float x2, float y2)
        {
        ...
        void quad_to_quad(const float* src, const float* dst)
        {
        ...
        void rect_to_quad(float x1, float y1, float x2, float y2, 
                          const float* quad)
        {
            float src[8];
            src[0] = src[6] = x1;
        ...
        void quad_to_rect(const float* quad, 
        ...
        void begin(float x, float y, unsigned len)
        {
            ...
            float xt = m_iterator.x;
            float yt = m_iterator.y;

            float dx;
            float dy;
            const float delta = 1/float(subpixel_scale);
            dx = xt + delta;
            dy = yt;
    ...
    public:
        ...
        //--------------------------------------------------------------------
        // Arbitrary quadrangle transformations
        span_interpolator_persp_lerp(const float* src, const float* dst) 
        {
            quad_to_quad(src, dst);
        }
        ...
        //--------------------------------------------------------------------
        // Direct transformations 
        span_interpolator_persp_lerp(float x1, float y1, 
                                     float x2, float y2, 
                                     const float* quad)
        {
            rect_to_quad(x1, y1, x2, y2, quad);
        ...
        //--------------------------------------------------------------------
        // Reverse transformations 
        span_interpolator_persp_lerp(const float* quad, 
                                     float x1, float y1, 
                                     float x2, float y2)
        {
            quad_to_rect(quad, x1, y1, x2, y2);
