...
namespace agg
{
    ...
    struct gray8
    {
        ...
        //--------------------------------------------------------------------
        gray8(const rgba& c) :
            v((value_type)uround((0.299f*c.r + 0.587f*c.g + 0.114f*c.b) * float(base_mask))),
            a((value_type)uround(c.a * float(base_mask))) {}

        //--------------------------------------------------------------------
        gray8(const rgba& c, float a_) :
            v((value_type)uround((0.299f*c.r + 0.587f*c.g + 0.114f*c.b) * float(base_mask))),
        ...
        //--------------------------------------------------------------------
        self_type gradient(self_type c, float k) const
        {
            self_type ret;
    ...
    inline gray8 gray8_pre(const rgba& c, float a)
    {
        return gray8(c,a).premultiply();
    }
    ...
    inline gray16 gray16_pre(const rgba& c, float a)
    {
        return gray16(c,a).premultiply();
    }
