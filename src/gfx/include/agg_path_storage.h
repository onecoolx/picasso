...
namespace agg
{
    ...
    public:
        ...
        void modify_vertex(unsigned idx, float x, float y);
        void modify_vertex(unsigned idx, float x, float y, unsigned cmd);
    ...
    //------------------------------------------------------------------------
    template<class T, unsigned S, unsigned P>
    inline void vertex_block_storage<T,S,P>::add_vertex(float x, float y, 
                                                        unsigned cmd)
    {
        T* coord_ptr = 0;
    ...
    //------------------------------------------------------------------------
    template<class T, unsigned S, unsigned P>
    inline unsigned vertex_block_storage<T,S,P>::last_vertex(float* x, float* y) const
    {
    ...
    //------------------------------------------------------------------------
    template<class T, unsigned S, unsigned P>
    inline unsigned vertex_block_storage<T,S,P>::prev_vertex(float* x, float* y) const
    {
    ...
    //------------------------------------------------------------------------
    template<class T, unsigned S, unsigned P>
    inline float vertex_block_storage<T,S,P>::last_x() const
    {
        if(m_total_vertices)
        {
    ...
    //------------------------------------------------------------------------
    template<class T, unsigned S, unsigned P>
    inline float vertex_block_storage<T,S,P>::last_y() const
    {
        if(m_total_vertices)
        {
            unsigned idx = m_total_vertices - 1;
    ...
    public:
        ...
        line_adaptor(float x1, float y1, float x2, float y2) :
    ...
    private:
        float                     m_coord[4];
        poly_plain_adaptor<float> m_line;
    };
    ...
    public:
        ...
        //--------------------------------------------------------------------
        path_base() : m_vertices(), m_iterator(0), m_rect(false) {}
        void remove_all() { m_vertices.remove_all(); m_iterator = 0; m_rect = false;}
        void free_all()   { m_vertices.free_all();   m_iterator = 0; m_rect = false;}
        ...
        void hline_rel(float dx);

        void vline_to(float y);
        void vline_rel(float dy);

        void arc_to(float rx, float ry,
                    float angle,
                    bool large_arc_flag,
                    bool sweep_flag,
                    float x, float y);

        void arc_rel(float rx, float ry,
                     float angle,
                     bool large_arc_flag,
                     bool sweep_flag,
                     float dx, float dy);

        void curve3(float x_ctrl, float y_ctrl, 
                    float x_to,   float y_to);

        void curve3_rel(float dx_ctrl, float dy_ctrl, 
                        float dx_to,   float dy_to);

        void curve3(float x_to, float y_to);

        void curve3_rel(float dx_to, float dy_to);

        void curve4(float x_ctrl1, float y_ctrl1, 
                    float x_ctrl2, float y_ctrl2, 
                    float x_to,    float y_to);

        void curve4_rel(float dx_ctrl1, float dy_ctrl1, 
                        float dx_ctrl2, float dy_ctrl2, 
                        float dx_to,    float dy_to);

        void curve4(float x_ctrl2, float y_ctrl2, 
                    float x_to,    float y_to);

        void curve4_rel(float x_ctrl2, float y_ctrl2, 
                        float x_to,    float y_to);
        ...
        void rel_to_abs(float* x, float* y) const;
        ...
        //--------------------------------------------------------------------
        void flip_x(float x1, float x2);
        void flip_y(float y1, float y2);
        ...
        //--------------------------------------------------------------------
        void translate(float dx, float dy, unsigned path_id=0);
        void translate_all_paths(float dx, float dy);
    ...
    //------------------------------------------------------------------------
    template<class VC> 
    inline void path_base<VC>::rel_to_abs(float* x, float* y) const
    {
    ...
    //------------------------------------------------------------------------
    template<class VC> 
    inline void path_base<VC>::move_to(float x, float y)
    {
    ...
    //------------------------------------------------------------------------
    template<class VC> 
    inline void path_base<VC>::move_rel(float dx, float dy)
    {
        rel_to_abs(&dx, &dy);
    ...
    //------------------------------------------------------------------------
    template<class VC> 
    inline void path_base<VC>::line_to(float x, float y)
    {
    ...
    //------------------------------------------------------------------------
    template<class VC> 
    inline void path_base<VC>::line_rel(float dx, float dy)
    {
        rel_to_abs(&dx, &dy);
    ...
    //------------------------------------------------------------------------
    template<class VC> 
    inline void path_base<VC>::hline_to(float x)
    {
    ...
    //------------------------------------------------------------------------
    template<class VC> 
    inline void path_base<VC>::hline_rel(float dx)
    {
        float dy = 0;
        rel_to_abs(&dx, &dy);
        m_vertices.add_vertex(dx, dy, path_cmd_line_to);
    ...
    //------------------------------------------------------------------------
    template<class VC> 
    inline void path_base<VC>::vline_to(float y)
    {
    ...
    //------------------------------------------------------------------------
    template<class VC> 
    inline void path_base<VC>::vline_rel(float dy)
    {
        float dx = 0;
        rel_to_abs(&dx, &dy);
        m_vertices.add_vertex(dx, dy, path_cmd_line_to);
    ...
    //------------------------------------------------------------------------
    template<class VC> 
    void path_base<VC>::arc_to(float rx, float ry,
                               float angle,
                               bool large_arc_flag,
                               bool sweep_flag,
                               float x, float y)
    ...
    //------------------------------------------------------------------------
    template<class VC> 
    void path_base<VC>::arc_rel(float rx, float ry,
                                float angle,
                                bool large_arc_flag,
                                bool sweep_flag,
                                float dx, float dy)
    ...
    //------------------------------------------------------------------------
    template<class VC> 
    void path_base<VC>::curve3(float x_ctrl, float y_ctrl, 
                               float x_to,   float y_to)
    {
    ...
    //------------------------------------------------------------------------
    template<class VC> 
    void path_base<VC>::curve3_rel(float dx_ctrl, float dy_ctrl, 
                                   float dx_to,   float dy_to)
    {
    ...
    //------------------------------------------------------------------------
    template<class VC> 
    void path_base<VC>::curve3(float x_to, float y_to)
    {
        float x0;
        float y0;
    ...
    //------------------------------------------------------------------------
    template<class VC> 
    void path_base<VC>::curve3_rel(float dx_to, float dy_to)
    {
        rel_to_abs(&dx_to, &dy_to);
        curve3(dx_to, dy_to);
    }
    ...
    //------------------------------------------------------------------------
    template<class VC> 
    void path_base<VC>::curve4(float x_ctrl1, float y_ctrl1, 
                               float x_ctrl2, float y_ctrl2, 
                               float x_to,    float y_to)
    {
    ...
    //------------------------------------------------------------------------
    template<class VC> 
    void path_base<VC>::curve4_rel(float dx_ctrl1, float dy_ctrl1, 
                                   float dx_ctrl2, float dy_ctrl2, 
                                   float dx_to,    float dy_to)
    {
    ...
    //------------------------------------------------------------------------
    template<class VC> 
    void path_base<VC>::curve4(float x_ctrl2, float y_ctrl2, 
                               float x_to,    float y_to)
    {
        float x0;
        float y0;
    ...
    //------------------------------------------------------------------------
    template<class VC> 
    void path_base<VC>::curve4_rel(float dx_ctrl2, float dy_ctrl2, 
                                   float dx_to,    float dy_to)
    {
        rel_to_abs(&dx_ctrl2, &dy_ctrl2);
        rel_to_abs(&dx_to,    &dy_to);
    ...
    //------------------------------------------------------------------------
    template<class VC> 
    inline unsigned path_base<VC>::last_vertex(float* x, float* y) const
    {
    ...
    //------------------------------------------------------------------------
    template<class VC> 
    inline unsigned path_base<VC>::prev_vertex(float* x, float* y) const
    {
    ...
    //------------------------------------------------------------------------
    template<class VC> 
    inline float path_base<VC>::last_x() const
    {
    ...
    //------------------------------------------------------------------------
    template<class VC> 
    inline float path_base<VC>::last_y() const
    {
    ...
    //------------------------------------------------------------------------
    template<class VC> 
    inline unsigned path_base<VC>::vertex(unsigned idx, float* x, float* y) const
    {
    ...
    //------------------------------------------------------------------------
    template<class VC> 
    void path_base<VC>::modify_vertex(unsigned idx, float x, float y)
    {
        m_vertices.modify_vertex(idx, x, y);
    }
    ...
    //------------------------------------------------------------------------
    template<class VC> 
    void path_base<VC>::modify_vertex(unsigned idx, float x, float y, unsigned cmd)
    {
    ...
    //------------------------------------------------------------------------
    template<class VC> 
    inline unsigned path_base<VC>::vertex(float* x, float* y)
    {
    ...
    unsigned path_base<VC>::perceive_polygon_orientation(unsigned start,
                                                         unsigned end)
    {
        // Calculate signed area (float area to be exact)
        //---------------------
    ...
    //------------------------------------------------------------------------
    template<class VC> 
    void path_base<VC>::flip_x(float x1, float x2)
    {
        unsigned i;
        float x, y;
    ...
    //------------------------------------------------------------------------
    template<class VC> 
    void path_base<VC>::flip_y(float y1, float y2)
    {
        unsigned i;
        float x, y;
        for(i = 0; i < m_vertices.total_vertices(); i++)
    ...
    //------------------------------------------------------------------------
    template<class VC> 
    void path_base<VC>::translate(float dx, float dy, unsigned path_id)
    {
        unsigned num_ver = m_vertices.total_vertices();
        for(; path_id < num_ver; path_id++)
        {
    ...
    //------------------------------------------------------------------------
    template<class VC> 
    void path_base<VC>::translate_all_paths(float dx, float dy)
    {
        unsigned idx;
        unsigned num_ver = m_vertices.total_vertices();
        for(idx = 0; idx < num_ver; idx++)
