...
namespace agg
{
    ...
    public:
        ...
        float x1() const { return m_clip_box.x1; }
        float y1() const { return m_clip_box.y1; }
        float x2() const { return m_clip_box.x2; }
        float y2() const { return m_clip_box.y2; }
    ...
    private:
        unsigned clipping_flags(float x, float y);
