...
namespace agg
{
    ...
    //==============================================span_image_filter_rgba_nn_nb
    template<class Source, class Interpolator> 
    class span_image_filter_rgba_nn_nb : 
    public span_image_filter<Source, Interpolator>
    {
    public:
        typedef Source source_type;
        ...
        //--------------------------------------------------------------------
        span_image_filter_rgba_nn_nb() {}
        span_image_filter_rgba_nn_nb(source_type& src, 
                                  interpolator_type& inter) :
            base_type(src, inter, 0) 
        {}
    ...
    //====================================span_image_filter_rgba_bilinear_clip_nb
    template<class Source, class Interpolator> 
    class span_image_filter_rgba_bilinear_clip_nb : 
    public span_image_filter<Source, Interpolator>
    {
    public:
        typedef Source source_type;
        ...
        //--------------------------------------------------------------------
        span_image_filter_rgba_bilinear_clip_nb() {}
        span_image_filter_rgba_bilinear_clip_nb(source_type& src, 
                                             const color_type& back_color,
                                             interpolator_type& inter) :
            base_type(src, inter, 0),
            m_back_color(back_color)
    ...
    //==================================================span_image_filter_rgba_nb
    template<class Source, class Interpolator> 
    class span_image_filter_rgba_nb : 
    public span_image_filter<Source, Interpolator>
    {
    public:
        typedef Source source_type;
        ...
        //--------------------------------------------------------------------
        span_image_filter_rgba_nb() {}
        span_image_filter_rgba_nb(source_type& src, 
                               interpolator_type& inter,
                               const image_filter_lut& filter) :
            base_type(src, inter, &filter) 
        {}
