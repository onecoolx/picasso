...
namespace agg
{
    ...
    //------------------------------------------------------------cross_product
    AGG_INLINE float cross_product(float x1, float y1, 
                                    float x2, float y2, 
                                    float x,  float y)
    {
    ...
    //--------------------------------------------------------point_in_triangle
    AGG_INLINE bool point_in_triangle(float x1, float y1, 
                                      float x2, float y2, 
                                      float x3, float y3, 
                                      float x,  float y)
    {
    ...
    //-----------------------------------------------------------calc_distance
    AGG_INLINE double calc_distance_d(double x1, double y1, double x2, double y2)
    {
        double dx = x2-x1;
        double dy = y2-y1;
    ...
    //-------------------------------------------------------calc_line_point_u
    AGG_INLINE float calc_segment_point_u(float x1, float y1, 
                                           float x2, float y2, 
                                           float x,  float y)
    {
        float dx = x2 - x1;
    ...
    AGG_INLINE float calc_segment_point_sq_distance(float x1, float y1, 
                                                     float x2, float y2, 
                                                     float x,  float y,
                                                     float u)
    {
    ...
    //-----------------------------------------------------intersection_exists
    AGG_INLINE bool intersection_exists(float x1, float y1, float x2, float y2,
    ...
    //--------------------------------------------------------calc_orthogonal
    AGG_INLINE void calc_orthogonal(float thickness,
                                    float x1, float y1,
                                    float x2, float y2,
                                    float* x, float* y)
    {
    ...
    //--------------------------------------------------------dilate_triangle
    AGG_INLINE void dilate_triangle(float x1, float y1,
                                    float x2, float y2,
                                    float x3, float y3,
                                    float *x, float* y,
                                    float d)
    {
        ...
        float dx3=0.0;
        float dy3=0.0; 
        float loc = cross_product(x1, y1, x2, y2, x3, y3);
    ...
    //------------------------------------------------------calc_triangle_area
    AGG_INLINE float calc_triangle_area(float x1, float y1,
                                         float x2, float y2,
                                         float x3, float y3)
    {
    ...
    //-------------------------------------------------------calc_polygon_area
    template<class Storage> float calc_polygon_area(const Storage& st)
    {
        unsigned i;
        float sum = 0.0;
        float x  = st[0].x;
    ...
    //------------------------------------------------------------------------
    inline float besj(float x, int n)
    {
        if(n < 0)
        {
            return 0;
