...
namespace agg
{
    ...
    public:
        ...
        void interpolation_step(float v) { m_interpolation_step = v; }
        float interpolation_step() const { return m_interpolation_step; }
    ...
    private:
        ...
        bspline        m_spline_x;
        bspline        m_spline_y;
        float         m_interpolation_step;
        unsigned       m_closed;
        status_e       m_status;
        unsigned       m_src_vertex;
        float         m_cur_abscissa;
        float         m_max_abscissa;
    };
