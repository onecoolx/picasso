...
namespace agg
{
    ...
    public:
        ...
        //-------------------------------------------------------------------
        void preserve_aspect_ratio(float alignx, 
                                   float aligny, 
        ...
        //-------------------------------------------------------------------
        void device_viewport(float x1, float y1, float x2, float y2)
        {
            m_device_x1 = x1;
            m_device_y1 = y1;
            m_device_x2 = x2;
        ...
        //-------------------------------------------------------------------
        void world_viewport(float x1, float y1, float x2, float y2)
        {
            m_world_x1 = x1;
            m_world_y1 = y1;
            m_world_x2 = x2;
        ...
        //-------------------------------------------------------------------
        void device_viewport(float* x1, float* y1, float* x2, float* y2) const
        {
            *x1 = m_device_x1;
            *y1 = m_device_y1;
            *x2 = m_device_x2;
        ...
        //-------------------------------------------------------------------
        void world_viewport(float* x1, float* y1, float* x2, float* y2) const
        {
            *x1 = m_world_x1;
            *y1 = m_world_y1;
            *x2 = m_world_x2;
        ...
        //-------------------------------------------------------------------
        void world_viewport_actual(float* x1, float* y1, 
        ...
        float align_x()              const { return m_align_x; }
        float align_y()              const { return m_align_y; }
        ...
        //-------------------------------------------------------------------
        void transform_scale_only(float* x, float* y) const
        {
            *x *= m_kx;
            *y *= m_ky;
        }
        ...
        //-------------------------------------------------------------------
        void inverse_transform_scale_only(float* x, float* y) const
        {
            *x /= m_kx;
            *y /= m_ky;
        }
        ...
        //-------------------------------------------------------------------
        float device_dx() const { return m_dx1 - m_wx1 * m_kx; }
        float device_dy() const { return m_dy1 - m_wy1 * m_ky; }
    ...
    inline void trans_viewport::update()
    {
        ...
        float world_x1  = m_world_x1;
        float world_y1  = m_world_y1;
        float world_x2  = m_world_x2;
        float world_y2  = m_world_y2;
        float device_x1 = m_device_x1;
        float device_y1 = m_device_y1;
        float device_x2 = m_device_x2;
        float device_y2 = m_device_y2;
