...
namespace agg
{
    ...
    template<class ColorT, class Order> struct comp_op_rgba_soft_light
    {
                                         ...
                                         unsigned a, unsigned cover)
        {
            ...
            if(sa > 0)
            {
                ...
                float da = float(p[Order::A] ? p[Order::A] : 1) / base_mask;
                if(cover < 255)
                {
                    a = (a * cover + 255) >> 8;
                }
    ...
    template<class ColorT, class Order> struct comp_op_table_rgba
    {
        ...
        typedef void (*comp_op_func_type)(value_type* p, 
                                          ...
                                          unsigned ca,
                                          unsigned cover);
        static comp_op_func_type g_rgba_comp_op_func[];
    };

    //==========================================================g_rgba_comp_op_func
    template<class ColorT, class Order> 
    typename comp_op_table_rgba<ColorT, Order>::comp_op_func_type
    comp_op_table_rgba<ColorT, Order>::g_rgba_comp_op_func[] = 
    {
    ...
    template<class ColorT, class Order> struct comp_op_adaptor_rgba
    {
        ...
        static AGG_INLINE void blend_pix(unsigned op, value_type* p, 
                                         ...
                                         unsigned cover)
        {
            comp_op_table_rgba<ColorT, Order>::g_rgba_comp_op_func[op]
    ...
    template<class ColorT, class Order> struct comp_op_adaptor_rgba_pre
    {
        ...
        static AGG_INLINE void blend_pix(unsigned op, value_type* p, 
                                         ...
                                         unsigned cover)
        {
            comp_op_table_rgba<ColorT, Order>::g_rgba_comp_op_func[op](p, cr, cg, cb, ca, cover);
        }
    };
    ...
    public:
        ...
        //--------------------------------------------------------------------
        AGG_INLINE void blend_solid_hspan(int x, int y, unsigned len, 
    ...
    typedef comp_op_adaptor_rgba<rgba8, order_rgba> blender_rgba32; //----blender_rgba32
    typedef comp_op_adaptor_rgba<rgba8, order_argb> blender_argb32; //----blender_argb32
    typedef comp_op_adaptor_rgba<rgba8, order_abgr> blender_abgr32; //----blender_abgr32
    typedef comp_op_adaptor_rgba<rgba8, order_bgra> blender_bgra32; //----blender_bgra32
   
    typedef comp_op_adaptor_rgba_pre<rgba8, order_rgba> blender_rgba32_pre; //----blender_rgba32_pre
    typedef comp_op_adaptor_rgba_pre<rgba8, order_argb> blender_argb32_pre; //----blender_argb32_pre
    typedef comp_op_adaptor_rgba_pre<rgba8, order_abgr> blender_abgr32_pre; //----blender_abgr32_pre
    typedef comp_op_adaptor_rgba_pre<rgba8, order_bgra> blender_bgra32_pre; //----blender_bgra32_pre

    //-----------------------------------------------------------------------
    typedef int32u pixel32_type;
    typedef pixfmt_alpha_blend_comp_rgba<blender_rgba32, rendering_buffer, pixel32_type> pixfmt_rgba32; //----pixfmt_rgba32
    typedef pixfmt_alpha_blend_comp_rgba<blender_argb32, rendering_buffer, pixel32_type> pixfmt_argb32; //----pixfmt_argb32
    typedef pixfmt_alpha_blend_comp_rgba<blender_abgr32, rendering_buffer, pixel32_type> pixfmt_abgr32; //----pixfmt_abgr32
    typedef pixfmt_alpha_blend_comp_rgba<blender_bgra32, rendering_buffer, pixel32_type> pixfmt_bgra32; //----pixfmt_bgra32

    typedef pixfmt_alpha_blend_comp_rgba<blender_rgba32_pre, rendering_buffer, pixel32_type> pixfmt_rgba32_pre; //----pixfmt_rgba32_pre
    typedef pixfmt_alpha_blend_comp_rgba<blender_argb32_pre, rendering_buffer, pixel32_type> pixfmt_argb32_pre; //----pixfmt_argb32_pre
    typedef pixfmt_alpha_blend_comp_rgba<blender_abgr32_pre, rendering_buffer, pixel32_type> pixfmt_abgr32_pre; //----pixfmt_abgr32_pre
    typedef pixfmt_alpha_blend_comp_rgba<blender_bgra32_pre, rendering_buffer, pixel32_type> pixfmt_bgra32_pre; //----pixfmt_bgra32_pre
