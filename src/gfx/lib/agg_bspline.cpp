...
namespace agg
{
    ...
    //------------------------------------------------------------------------
    bspline::bspline(int num, const float* x, const float* y) :
        m_max(0),
        m_num(0),
        m_x(0),
        m_y(0),
    ...
    //------------------------------------------------------------------------
    void bspline::add_point(float x, float y)
    {
        if(m_num < m_max)
        {
            m_x[m_num] = x;
    ...
    //------------------------------------------------------------------------
    void bspline::init(int num, const float* x, const float* y)
    {
        if(num > 2)
        {
            init(num);
    ...
    //------------------------------------------------------------------------
    void bspline::bsearch(int n, const float *x, float x0, int *i) 
    {
        int j = n - 1;
        int k;
    ...
    //------------------------------------------------------------------------
    float bspline::interpolation(float x, int i) const
    {
        int j = i + 1;
        float d = m_x[i] - m_x[j];
        float h = x - m_x[j];
    ...
    //------------------------------------------------------------------------
    float bspline::extrapolation_left(float x) const
    {
        float d = m_x[1] - m_x[0];
    ...
    //------------------------------------------------------------------------
    float bspline::extrapolation_right(float x) const
    {
        float d = m_x[m_num - 1] - m_x[m_num - 2];
    ...
    //------------------------------------------------------------------------
    float bspline::get_stateful(float x) const
    {
        if(m_num > 2)
        {
            // Extrapolation on the left
