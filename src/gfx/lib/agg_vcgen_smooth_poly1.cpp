...
namespace agg
{
                                       ...
                                       const vertex_dist& v3)
    {
        ...
        float k1 = v0.dist / (v0.dist + v1.dist);
        float k2 = v1.dist / (v1.dist + v2.dist);

        float xm1 = v0.x + (v2.x - v0.x) * k1;
        float ym1 = v0.y + (v2.y - v0.y) * k1;
        float xm2 = v1.x + (v3.x - v1.x) * k2;
        float ym2 = v1.y + (v3.y - v1.y) * k2;
    ...
    //------------------------------------------------------------------------
    unsigned vcgen_smooth_poly1::vertex(float* x, float* y)
    {
