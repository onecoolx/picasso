 ...
 */
typedef unsigned short ps_uchar16;
 ...
 * \param matrix   Pointer to an existing matrix object.
 *
 * \sa ps_gradient_create_linear, ps_gradient_create_radial, ps_gradient_create_conic, ps_gradient_ref, ps_gradient_unref
 */
...
/**
 * \fn void ps_gradient_add_color_stop(ps_gradient* gradient, double offset, const ps_color* color)
 ...
 */
PEXPORT void PICAPI ps_gradient_add_color_stop(ps_gradient* gradient, double offset, const ps_color* color);
...
/**
 * \fn double ps_set_line_width(ps_context* ctx, double width)
 ...
 *     ps_set_line_dash, ps_reset_line_dash, ps_set_line_inner_join
 */
PEXPORT double PICAPI ps_set_line_width(ps_context* ctx, double width);

/**
 * \fn double ps_set_miter_limit(ps_context* ctx, double limit)
 ...
 *     ps_set_line_dash, ps_reset_line_dash, ps_set_line_inner_join
 */
PEXPORT double PICAPI ps_set_miter_limit(ps_context* ctx, double limit);
...
/**
 * \fn void ps_set_line_dash(ps_context* ctx, double start, double* dashes, unsigned int num_dashes)
 ...
 */
PEXPORT void PICAPI ps_set_line_dash(ps_context* ctx, double start, double* dashes, unsigned int num_dashes);
...
/**
 * \fn void ps_set_shadow(ps_context* ctx, double x_offset, double y_offset, double blur)
 ...
 */
PEXPORT void PICAPI ps_set_shadow(ps_context* ctx, double x_offset, double y_offset, double blur);
...
/**
 * \fn double ps_set_alpha(ps_context* ctx, double alpha)
 ...
 */
PEXPORT double PICAPI ps_set_alpha(ps_context* ctx, double alpha);

/**
 * \fn double ps_set_gamma(ps_context* ctx, double gamma)
 ...
 */
PEXPORT double PICAPI ps_set_gamma(ps_context* ctx, double gamma);
...
/**
 * \fn double ps_set_blur(ps_context* ctx, double blur)
 ...
 */
PEXPORT double PICAPI ps_set_blur(ps_context* ctx, double blur);
...
/**
 * \fn void ps_font_set_size(ps_font* font, double size)
 ...
 */
PEXPORT void PICAPI ps_text_out_length(ps_context* ctx, double x, double y, const char* text, unsigned int length);
 ...
 */
PEXPORT void PICAPI ps_show_glyphs(ps_context* ctx, double x, double y, ps_glyph* glyphs, unsigned int length);
...
/**
 * \fn void ps_translate(ps_context* ctx, double tx, double ty)
 ...
 */
PEXPORT void PICAPI ps_translate(ps_context* ctx, double tx, double ty);

/**
 * \fn void ps_scale(ps_context* ctx, double sx, double sy)
 ...
 */
PEXPORT void PICAPI ps_scale(ps_context* ctx, double sx, double sy);

/**
 * \fn void ps_shear(ps_context* ctx, double shx, double shy)
 ...
 */
PEXPORT void PICAPI ps_shear(ps_context* ctx, double shx, double shy);
 ...
 */
PEXPORT void PICAPI ps_rotate(ps_context* ctx, double angle);
 ...
 */
PEXPORT void PICAPI ps_matrix_translate(ps_matrix* matrix, double tx, double ty);

/**
 * \fn void ps_matrix_scale(ps_matrix* matrix, double sx, double sy)
 ...
 */
PEXPORT void PICAPI ps_matrix_scale(ps_matrix* matrix, double sx, double sy);

/**
 * \fn void ps_matrix_rotate(ps_matrix* matrix, double angle)
 ...
 */
PEXPORT void PICAPI ps_matrix_rotate(ps_matrix* matrix, double angle);

/**
 * \fn void ps_matrix_shear(ps_matrix* matrix, double shx, double shy)
 ...
 */
PEXPORT void PICAPI ps_matrix_shear(ps_matrix* matrix, double shx, double shy);
...
/**
 * \fn double ps_matrix_get_determinant(const ps_matrix* matrix)
 ...
 */
PEXPORT double PICAPI ps_matrix_get_determinant(const ps_matrix* matrix);

/**
 * \fn void ps_matrix_set_translate_factor(ps_matrix* matrix, double tx, double ty)
 ...
 */
PEXPORT void PICAPI ps_matrix_set_translate_factor(ps_matrix* matrix, double tx, double ty);

/**
 * \fn ps_bool ps_matrix_get_translate_factor(ps_matrix* matrix, double *tx, double *ty)
 ...
 */
PEXPORT ps_bool PICAPI ps_matrix_get_translate_factor(ps_matrix* matrix, double *tx, double *ty);

/**
 * \fn void ps_matrix_set_scale_factor(ps_matrix* matrix, double sx, double sy)
 ...
 */
PEXPORT void PICAPI ps_matrix_set_scale_factor(ps_matrix* matrix, double sx, double sy);

/**
 * \fn ps_bool ps_matrix_get_scale_factor(ps_matrix* matrix, double *sx, double *sy)
 ...
 */
PEXPORT ps_bool PICAPI ps_matrix_get_scale_factor(ps_matrix* matrix, double *sx, double *sy);

/**
 * \fn void ps_matrix_set_shear_factor(ps_matrix* matrix, double shx, double shy)
 ...
 */
PEXPORT void PICAPI ps_matrix_set_shear_factor(ps_matrix* matrix, double shx, double shy);

/**
 * \fn ps_bool ps_matrix_get_shear_factor(ps_matrix* matrix, double *shx, double *shy)
 ...
 */
PEXPORT ps_bool PICAPI ps_matrix_get_shear_factor(ps_matrix* matrix, double *shx, double *shy);
...
/**
 * \fn void ps_arc(ps_context* ctx, const ps_point* cp, double radius, 
 *                                        double sangle, double eangle, ps_bool clockwise)
 ...
 *     ps_tangent_arc, ps_rectangle, ps_rounded_rect, ps_ellipse
 */
PEXPORT void PICAPI ps_arc(ps_context* ctx, const ps_point* cp, double radius, 
                                           double sangle, double eangle, ps_bool clockwise);

/**
 * \fn void ps_tangent_arc(ps_context* ctx, const ps_rect* rect, double sangle, double sweep)
 ...
 */
PEXPORT void PICAPI ps_tangent_arc(ps_context* ctx, const ps_rect* rect, double sangle, double sweep);
...
/**
 * \fn void ps_path_tangent_arc_to(ps_path* path, double radius, const ps_point* tp, const ps_point* ep)
 ...
 */
PEXPORT void PICAPI ps_path_tangent_arc_to(ps_path* path, double radius, const ps_point* tp, const ps_point* ep);
...
/**
 * \fn double ps_path_get_length(const ps_path* path)
 ...
 */
PEXPORT double PICAPI ps_path_get_length(const ps_path* path);
