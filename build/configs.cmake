...
elseif (UNIX AND NOT APPLE)
    ...
    if (OPT_UNITTEST)
        set(UNITTEST "-fno-builtin -fno-strict-aliasing -fno-tree-vectorize")
    else()
        set(UNITTEST "")
    endif()
    set(CMAKE_C_FLAGS_DEBUG "-D_DEBUG -O0 -Wall -fPIC -g ${SANITIZE} ${COVERAGE} ${UNITTEST}")
    set(CMAKE_CXX_FLAGS_DEBUG "-D_DEBUG -O0 -Wall -fPIC -g -std=c++11 -fno-rtti -fno-exceptions -Wno-unknown-warning-option -Wno-unused-result -Wno-attributes ${SANITIZE} ${COVERAGE} ${UNITTEST}")
    set(CMAKE_C_FLAGS_RELEASE "-DNDEBUG -O3 -Wall -fPIC -ffunction-sections -fdata-sections -flto=auto ${SANITIZE} ${COVERAGE} ${UNITTEST}")
    set(CMAKE_CXX_FLAGS_RELEASE "-DNDEBUG -O3 -Wall -fPIC -std=c++11 -fno-rtti -fno-exceptions -flto=auto -Wno-unknown-warning-option -Wno-unused-result -Wno-attributes -ffunction-sections -fdata-sections ${SANITIZE} ${COVERAGE} ${UNITTEST}")
    set(CMAKE_SHARED_LINKER_FLAGS "-Wl,--gc-sections")
elseif (APPLE)
    if (OPT_UNITTEST)
        set(UNITTEST "-fno-builtin -fno-strict-aliasing -ffp-model=precise -ffp-contract=off -fno-vectorize -fno-slp-vectorize")
