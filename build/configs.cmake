...
elseif (UNIX AND NOT APPLE)
    ...
    set(CMAKE_CXX_FLAGS_DEBUG "-D_DEBUG -O0 -Wall -fPIC -g -std=c++11 -fno-rtti -fno-exceptions ${SANITIZE} ${COVERAGE} ${UNITTEST}")
    set(CMAKE_C_FLAGS_RELEASE "-DNDEBUG -O3 -Wall -fPIC ${SANITIZE} ${COVERAGE} ${UNITTEST}")
    set(CMAKE_CXX_FLAGS_RELEASE "-DNDEBUG -O3 -Wall -fPIC -std=c++11 -fno-rtti -fno-exceptions ${SANITIZE} ${COVERAGE} ${UNITTEST}")
elseif (APPLE)
    if (OPT_UNITTEST)
