...
elseif (UNIX AND NOT APPLE)
    ...
    set(main_file ${PROJECT_ROOT}/test/gles2/testGLES2.c)
    else()
...
if (OPT_GLES2_BACKEND)
set(LIB_TARGET ${LIB_NAME_GLES} GLESv2 EGL X11)
add_definitions(-DENABLE_EGL=1)
else()
...
foreach(test_file ${TEST_SOURCES})
    ...
    target_link_libraries(${test} PRIVATE ${LIB_TARGET} PUBLIC ${host_gui_lib})
...
foreach(image_file ${IMAGE_SOURCES})
    ...
    target_link_libraries(${image_name} PRIVATE ${LIB_TARGET} psx_image PUBLIC ${host_gui_lib})
